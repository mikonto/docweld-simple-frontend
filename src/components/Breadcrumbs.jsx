 ...
 * @param {Object} props.breadcrumbData - Data for entity names in breadcrumbs
 * @param {string} props.breadcrumbData.projectName - Project name to display
 * @param {string} props.breadcrumbData.collectionName - Collection name to display
 * @param {string} props.breadcrumbData.weldLogName - Weld log name to display
 */
export function Breadcrumbs({ className, breadcrumbData = {} }) {
...
Breadcrumbs.propTypes = {
  ...
  breadcrumbData: PropTypes.shape({
    ...
    weldLogName: PropTypes.string,
    weldNumber: PropTypes.string,
  }),
};
