...
describe('DataTable Component', () => {
  ...
  it('should display error state', () => {
    const error: DataTableError = { message: 'Failed to load data' };
  ...
  it('should display and handle action buttons', async () => {
    ...
    const mockActionButtons: ActionButton[] = [
      {
        label: 'Add New',
  ...
  it('should display and handle bulk action buttons when rows are selected', async () => {
    ...
    const mockBulkActionButtons: BulkActionButton[] = [
      {
  ...
  it('should show pagination with large datasets', () => {
    ...
    const largeData: MockDataItem[] = Array.from({ length: 15 }, (_, i) => ({
      id: i + 1,
      name: `Project ${i + 1}`,
