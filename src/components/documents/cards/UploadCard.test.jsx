...
describe('UploadCard', () => {
  ...
  beforeEach(async () => {
    ...
    const { useDragAndDrop } = await import('@/hooks/documents');
  ...
  it('should display drag text when dragging', async () => {
    const { useDragAndDrop } = await import('@/hooks/documents');
    useDragAndDrop.mockReturnValue({
      isDragging: true,
      dragProps: {},
  ...
  it('should show tooltip with file format information', async () => {
  ...
  it('should apply correct styling when dragging', async () => {
    const { useDragAndDrop } = await import('@/hooks/documents');
    useDragAndDrop.mockReturnValue({
      isDragging: true,
      dragProps: {},
