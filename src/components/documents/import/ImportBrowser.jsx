...
function ImportBrowser({
  ...
  onCancel,
  allowMultiple = true,
  mode = 'both', // "section", "document", or "both"
  sourceType = 'documentLibrary', // "documentLibrary" or "projectLibrary"
  projectId = null, // needed for projectLibrary source type
}) {
...
ImportBrowser.propTypes = {
  onSelectItems: PropTypes.func.isRequired,
  onCancel: PropTypes.func.isRequired,
  allowMultiple: PropTypes.bool,
  mode: PropTypes.oneOf(['section', 'document', 'both']),
  sourceType: PropTypes.oneOf(['documentLibrary', 'projectLibrary']),
