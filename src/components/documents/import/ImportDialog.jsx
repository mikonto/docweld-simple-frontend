...
export default function ImportDialog({
  ...
  const [importSource, setImportSource] = useState('documentLibrary');
...
ImportDialog.propTypes = {
  ...
  mode: PropTypes.oneOf(['section', 'document']),
  targetSectionId: PropTypes.string,
  importSourcePath: PropTypes.string,
  importSourceStoragePath: PropTypes.string,
  projectId: PropTypes.string,
  hideProjectDocuments: PropTypes.bool,
};
