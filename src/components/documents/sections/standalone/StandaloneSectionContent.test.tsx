...
import type { StandaloneSectionContentProps } from './StandaloneSectionContent';
import type { Document } from '@/types/database';
import type { Timestamp } from 'firebase/firestore';

// Mock the card components
vi.mock('@/components/documents/cards', () => ({
  Card: ({ id, title }: { id: string; title: string }) => (
...
describe('StandaloneSectionContent', () => {
  ...
  const defaultProps: StandaloneSectionContentProps = {
