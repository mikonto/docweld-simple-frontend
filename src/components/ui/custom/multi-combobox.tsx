 ...
 * @param showAddNew - Whether to show "Add new" option
 * @param onAddNew - Callback when "Add new" is clicked
 * @param addNewLabel - Label for "Add new" button
 */
export function MultiCombobox({
  ...
  const getDisplayLabel = (itemValue: string): string => {
