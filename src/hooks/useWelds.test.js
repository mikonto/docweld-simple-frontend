...
describe('useWelds Hook', () => {
  ...
  describe('useWeld', () => {
    it('should return weld data when found', () => {
      ...
      useDocument.mockReturnValue([mockWeld, false, null]);
    ...
    it('should return null when weld does not exist', () => {
      ...
      useDocument.mockReturnValue([mockSnapshot, false, null]);
  ...
  it('should show error message when weld number is already in use', async () => {
    ...
    await act(async () => {
      try {
        ...
        expect(error.message).toBe('Weld number 123 is already in use');
      }
    });
  ...
  it('should show error message for invalid range', async () => {
    ...
    await act(async () => {
      try {
        ...
        expect(error.message).toBe('Invalid number range');
      }
    });
