...
describe('MaterialManagement', () => {
  const mockMaterials = [
    { id: '1', name: 'Steel Grade A', type: 'parent', dimensions: '10mm' },
    { id: '2', name: 'Steel Grade B', type: 'filler', dimensions: '20mm' },
  ];
  ...
  beforeEach(async () => {
    ...
    useMaterials.mockReturnValue([mockMaterials, false, null]);
    useMaterialOperations.mockReturnValue(mockOperations);
  });
  ...
  it('should show loading state', async () => {
    ...
    useMaterials.mockReturnValue([[], true, null]);
