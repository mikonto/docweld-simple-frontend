...
vi.mock('./ProjectsTable', () => ({
  ProjectsTable: ({ onCreateNew, activeTab, onTabChange }) => (
...
vi.mock('@/components/shared/ErrorLoadingWrapper', () => ({
  ErrorLoadingWrapper: ({ children, error, loading, resourceName }) => {
...
describe('Projects Page', () => {
  ...
  beforeEach(async () => {
    ...
    useProjects.mockReturnValue([mockProjects, false, null]);
  });
  ...
  it('should show loading state', async () => {
    const { useProjects } = vi.mocked(await import('@/hooks/useProjects'));
    useProjects.mockReturnValue([[], true, null]);
